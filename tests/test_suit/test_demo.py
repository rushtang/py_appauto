...
from pages.pageset import ProductPages as p,UserPages as up
from base import page
from base.utils import log
from base.exceptions import NotFoundTextError
...
class Test_demo():
    ...
    def test_推荐频道(self, action: ElementActions):
        ...
        推荐按钮ele=action.find_ele_recursive(导航栏ele,p.特卖首页.导航栏_推荐)
        ...
        for count in range(10):
            ...
            商品栏列表eles=action.find_ele_recursive(推荐商品栏ele,p.特卖首页.推荐商品栏_商品栏,is_Multiple=True)
    ...
    #
    #     action.sleep(3).start_activity(p.特卖首页.activity)
    #
